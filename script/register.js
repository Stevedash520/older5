var xiaownq = {
	...
	verification() {
		...
		let subwnqtStep = document.getElementsByClassName('subwnqt-step')[1];
	...
	regboxthree() {
		...
		let btn = document.getElementsByClassName('subwnqt-step')[2];
	...
	// 登录
	login() {
		let btn = document.getElementsByClassName('subwnqt-step')[3];
		let num = "226";
		for (let i = 0; i < 7; i++) {
			num += (Math.random() * 10) | 0;
		}
